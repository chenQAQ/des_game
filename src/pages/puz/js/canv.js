function Countdown() {
  ...
  this.settings = {
    ...
    size: 100,            // 绘制圆形的最大尺寸，宽=高
    borderWidth: 1,       // 边框宽度
    borderColor:"#fff",   // 边框颜色
    outerColor:"#fff",    // 最外层底圆颜色
    scheduleColor:"#fff", // 进度条动画颜色
    fontColor: "#fff",    // 字体颜色
    ringColor: "#fff139", // 进度条环形颜色
    innerColor: "#7aa5e5",// 最内圆底色
    fontSize: 50,
    time: 5,
    over:false,
  }
...
Countdown.prototype.drawInner = function () {
  this.drawCircle(0, 360, 12, this.settings.innerColor);
...
Countdown.prototype.strokeText = function (text) {
  ...
  this.ctx.fillText(text, this.settings.size / 2, this.settings.size / 1.8);
};
// 绘制圆
