<template>
  <div class="container">
      <div class="ready" v-if="isReady==false" :style="bgstyle(activitydata.count_down_background)">
        <p class="ready-time" ref="countp">{{readyContent}}</p>
      </div>
      <div class="beatdown" v-else >
        <div class="top-block">
          <div class="teampk-msg-box">
            <p>张三用时1.5秒最快答对，为团队赢得100分</p>
          </div>
          <div class="teampk-user-box">
          </div>
